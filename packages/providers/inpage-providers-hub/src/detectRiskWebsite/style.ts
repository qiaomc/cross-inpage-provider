...
.qiaomc-inject-bodyLg {
	/* bodyLg */
	font-size: 16px;
	font-weight: 400;
	line-height: 24px; /* 150% */
}
.qiaomc-inject-bodyLg-medium {
	/* bodyLg-medium */
	font-size: 16px;
	font-weight: 500;
	line-height: 24px; /* 150% */
...
.qiaomc-inject-risk-warning {
	margin-bottom: 20px;
}
.qiaomc-inject-text-wrap {
	margin: 0;
	margin-top: 20px;
}
.qiaomc-inject-text-subdued {
  margin-top: 8px;
  margin-bottom: 0px;
	color: rgba(0, 0, 0, 0.61);
}
.qiaomc-inject-continue-link {
	text-decoration: underline;
	cursor: pointer;
}
.qiaomc-inject-continue-link:hover {
	color: rgba(0, 0, 0, 0.7);
}
.qiaomc-inject-continue-link:active {
	color: rgba(0, 0, 0, 0.5);
}
.qiaomc-inject-footer {
	display: flex;
	padding:16px 20px;
	flex-direction: row;
...
@media (prefers-color-scheme: dark) {
	...
	.qiaomc-inject-error-icon-content {
