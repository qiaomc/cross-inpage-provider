...
type QiaoMcTonProviderProps = IInpageProviderConfig & {
  timeout?: number;
};
...
export class ProviderTon extends ProviderTonBase implements IProviderTon {
  ...
  walletInfo?: WalletInfo = {
    name: 'QiaoMc',
    image: 'https://common.qiaomc-asset.com/logo/qiaomc-x288.png',
    about_url: 'https://qiaomc.so',
  };
  protocolVersion = 2;
  isWalletBrowser = false;

  constructor(props: QiaoMcTonProviderProps) {
    super({
      ...props,
