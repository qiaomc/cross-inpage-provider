...
type QiaoMcSuiSignTransactionInput = Omit<SuiSignTransactionInput, 'transaction' | 'signal'> & {
  transaction: string;
};

type QiaoMcSuiSignAndExecuteTransactionInput = Omit<
  SuiSignAndExecuteTransactionInput,
  'transaction' | 'signal'
> & {
  transaction: string;
...
export type SuiRequest = {
  ...
  'signTransaction': (input: QiaoMcSuiSignTransactionInput) => Promise<SignedTransaction>;

  'signAndExecuteTransaction': (
    input: QiaoMcSuiSignAndExecuteTransactionInput,
...
export type QiaoMcSuiProviderProps = IInpageProviderConfig & {
  timeout?: number;
};
...
class ProviderSui extends ProviderSuiBase implements IProviderSui {
  ...
  constructor(props: QiaoMcSuiProviderProps) {
    super({
      ...props,
