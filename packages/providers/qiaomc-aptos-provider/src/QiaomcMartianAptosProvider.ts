...
import { AptosProviderType, ProviderAptos } from './QiaomcAptosProvider';
...
type QiaoMcAptosProviderProps = IInpageProviderConfig & {
  timeout?: number;
};
...
class ProviderAptosMartian extends ProviderAptos {
  ...
  constructor(props: QiaoMcAptosProviderProps) {
    super({
      ...props,
