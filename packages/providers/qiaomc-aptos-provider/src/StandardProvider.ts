...
import { stripHexPrefix, bytesToHex } from '@qiaomcfe/cross-inpage-provider-core';
...
import type { ProviderAptos } from './QiaomcAptosProvider';
...
export class AptosStandardProvider implements AptosWallet {
  readonly url: string = 'https://qiaomc.so';

  readonly options?: WalletInfo;

  readonly version = '1.0.0';

  readonly name: string = 'QiaoMc';
